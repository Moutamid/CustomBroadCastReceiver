...
import com.moutamid.broadcastreceiver.databinding.ActivityRestaurantsBinding;
...
public class RestaurantsActivity extends AppCompatActivity {
    ...
    private ActivityRestaurantsBinding b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b = ActivityRestaurantsBinding.inflate(getLayoutInflater());
        setContentView(b.getRoot());
        Log.d(TAG, "onCreate: ");

        transaction = getSupportFragmentManager().beginTransaction();

        listFragment1 = new ListFragment1(RESTAURANT);
        browserFragment = new BrowserFragment(RESTAURANT);
